...
def get_project_by_title(title):
    ...
    print """\n Project: {title}
            Description: {description}""".format(title=title, description=row[0])
...
def get_grade_by_github_title(github, title):
    ...
    print """
              ...
              Student grade {} """.format(github, title, row[0])
...
def assign_grade(github, title, grade):
    ...
    print "Successfully added grade {} on project {} for student {}".format(
        grade, title, github)
